...
require(
    ...
    "Project memory stays in the existing repository",
    "Platform support",
    ".exocortex/docs/AI_INSTALLATION.md",
...
require_compact(
    "README.md",
    "Do not treat a fresh template clone or a bare Git snapshot that omits local data as a replacement",
    "An approved disposable rehearsal or isolated worktree is allowed",
    "Preserve all project data byte-for-byte",
    "recognized Session Context backup sidecars",
    "An update changes the Exocortex code plane only",
...
require(
    ...
    "Other code-plane changes get the quick contracts",
    "runs in CI, never in the hook",
