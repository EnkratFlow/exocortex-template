---
name: ecosystem
description: "Manual-only Exocortex command /ecosystem: Cross-project activity view from EnkratFlow hub (read-only)"
---
...
3. Execute `.exocortex/commands/ecosystem.json` exactly as written, preserving its order and user choices.
