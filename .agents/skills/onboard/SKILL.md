---
name: onboard
description: "Manual-only Exocortex command /onboard: Read and understand the codebase before starting work. Builds a working mental model of the project structure, entry points, architecture, and current context."
---
