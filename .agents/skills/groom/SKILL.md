---
name: groom
description: "Manual-only Exocortex command /groom: Control Center: Process captured interrupts"
---
...
3. Execute `.exocortex/commands/groom.json` exactly as written, preserving its order and user choices.
