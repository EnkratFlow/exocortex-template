---
name: brief
description: "Model-invocable read-only Exocortex command /brief: Quick status check - current state and priorities"
---
...
3. Execute `.exocortex/commands/brief.json` exactly as written, preserving its order and user choices.
