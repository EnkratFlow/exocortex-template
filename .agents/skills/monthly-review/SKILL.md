---
name: monthly-review
description: "Manual-only Exocortex command /monthly-review: Monthly directional review: vision alignment, trends, course correction"
---
...
3. Execute `.exocortex/commands/monthly-review.json` exactly as written, preserving its order and user choices.
