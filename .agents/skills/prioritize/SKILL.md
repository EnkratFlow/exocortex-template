---
name: prioritize
description: "Manual-only Exocortex command /prioritize: Reorder TODO.md by strategic importance through guided questions"
---
...
3. Execute `.exocortex/commands/prioritize.json` exactly as written, preserving its order and user choices.
