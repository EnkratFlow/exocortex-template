---
name: work
description: "Model-invocable read-only Exocortex command /work: Load context and identify next task"
---
...
3. Execute `.exocortex/commands/work.json` exactly as written, preserving its order and user choices.
