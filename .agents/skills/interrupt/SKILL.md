---
name: interrupt
description: "Manual-only Exocortex command /interrupt: Control Center: Quickly capture idea during active work"
---
...
3. Execute `.exocortex/commands/interrupt.json` exactly as written, preserving its order and user choices.
