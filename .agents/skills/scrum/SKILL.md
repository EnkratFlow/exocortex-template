---
name: scrum
description: "Model-invocable read-only Exocortex command /scrum: Control Center: Daily standup (yesterday/today/blockers)"
---
...
3. Execute `.exocortex/commands/scrum.json` exactly as written, preserving its order and user choices.
