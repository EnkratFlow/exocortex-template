---
name: refine-backlog
description: "Manual-only Exocortex command /refine-backlog: Process backlog items: promote to TODO, defer, or delete"
---
...
3. Execute `.exocortex/commands/refine-backlog.json` exactly as written, preserving its order and user choices.
