---
name: handoff
description: "Manual-only Exocortex command /handoff: Prepare or record a strict project-local cross-provider handoff"
---
...
3. Execute `.exocortex/commands/handoff.json` exactly as written, preserving its order and user choices.
