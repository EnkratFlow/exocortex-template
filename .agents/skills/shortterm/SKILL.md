---
name: shortterm
description: "Model-invocable read-only Exocortex command /shortterm: Display short-term memory (7-31 days) with AI analysis"
---
...
3. Execute `.exocortex/commands/shortterm.json` exactly as written, preserving its order and user choices.
