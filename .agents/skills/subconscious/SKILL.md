---
name: subconscious
description: "Model-invocable read-only Exocortex command /subconscious: Cross-cutting pattern detection across ALL events (no time filter)"
---
...
3. Execute `.exocortex/commands/subconscious.json` exactly as written, preserving its order and user choices.
