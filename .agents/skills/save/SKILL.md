---
name: save
description: "Manual-only Exocortex command /save: Draft a local narrative save and optionally save that exact summary locally; not a checkpoint"
---
...
3. Execute `.exocortex/commands/save.json` exactly as written, preserving its order and user choices.
