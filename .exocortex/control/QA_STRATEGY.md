...
| Release/deployment | exact candidate and artifact hashes, build/package evidence, rollback readiness | release-specific review | separate release/deployment approval and hypercare exit |
...
5. Release, deployment, and hypercare evidence remain separately approved.
