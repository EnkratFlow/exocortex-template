...
- The packaged candidate version is `3.3.1`. This tracked file does not prove a
...
Before version 3.3.1 may be used as a public installation or update source:
...
1. Provision a separately installed, independently reviewed publication
   ...
   Python, Git, and GitHub CLI SHA-256 digests; 3.3.1 cannot bootstrap trust
...
- The 3.3.1 metadata and integrity inventories are part of the candidate;
