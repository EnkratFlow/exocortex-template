...
- Cursor: Uses user rules (Settings > General > Rules for AI) to trigger `.exocortex/AI_BOOTSTRAP.md`
- VS Code / other editors: Tell the AI "read .exocortex/AI_BOOTSTRAP.md" at session start
- All editors: Commands work identically once AI_BOOTSTRAP.md is loaded
